...
Begin VB.Form FrmCancel 
   ...
   Begin VB.Frame FraCliente 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel LblCpf 
         ...
         Width           =   375
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblPai 
         Height          =   255
         Left            =   120
         ...
         Width           =   375
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblMae 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCancel.frx":0316
         TabIndex        =   12
         Top             =   2520
         Width           =   375
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResCodCli 
         Height          =   255
         Left            =   1200
         OleObjectBlob   =   "FrmCancel.frx":037C
         TabIndex        =   13
         Top             =   360
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResNome 
         Height          =   255
         Left            =   840
         OleObjectBlob   =   "FrmCancel.frx":03E6
         TabIndex        =   14
         Top             =   720
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResDtNasc 
         Height          =   255
         Left            =   1080
         OleObjectBlob   =   "FrmCancel.frx":0450
         TabIndex        =   15
         Top             =   1080
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResIdent 
         Height          =   255
         Left            =   1200
         OleObjectBlob   =   "FrmCancel.frx":04BA
         TabIndex        =   16
         Top             =   1440
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResCpf 
         Height          =   255
         Left            =   600
         OleObjectBlob   =   "FrmCancel.frx":0524
         TabIndex        =   17
         Top             =   1800
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResPai 
         Height          =   255
         Left            =   600
         OleObjectBlob   =   "FrmCancel.frx":058E
         TabIndex        =   18
         Top             =   2160
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblResMae 
         Height          =   255
         Left            =   600
         OleObjectBlob   =   "FrmCancel.frx":05F8
         TabIndex        =   19
         Top             =   2520
         Width           =   615
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4200
      OleObjectBlob   =   "FrmCancel.frx":0662
      Top             =   4320
   End
End
    ...
    If TxtNumCart.Text <> "" Then
        ...
        Else        'achou cartão
            ...
            Else    'NÃO está cancelado.
                ...
                StrSql = "Select CodCli,Nome,NascDia,NascMes,NascAno,Ident,Cpf,Pai,Mae from tb_cliente where CodCli=" & RecCart.Fields.Item(0).Value
                ...
                LblResPai.Caption = RecCli.Fields.Item(7).Value
                LblResMae.Caption = RecCli.Fields.Item(8).Value
                ...
                LblResPai.Visible = True
                LblResMae.Visible = True
...
Private Sub Form_Load()
    ...
    LblResPai.Visible = False
    LblResMae.Visible = False
    CmdCancel.Enabled = False
