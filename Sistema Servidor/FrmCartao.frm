...
Begin VB.Form FrmCartao 
   ...
   Begin VB.Frame FraRecarga 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel LblDtCart 
         Height          =   255
         Left            =   360
         OleObjectBlob   =   "FrmCartao.frx":02B8
         TabIndex        =   6
         Top             =   720
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblCodCli 
         Height          =   255
         Left            =   360
         OleObjectBlob   =   "FrmCartao.frx":0334
         TabIndex        =   7
         Top             =   1080
         Width           =   1335
      End
...
Private Sub CmdIncluir_Click()
    ...
    If TxtNumCartao.Text = "" Or TxtDtCart.Text = "" Or TxtCodCli.Text = "" Then
            ...
            If Not RecNumCar.EOF Then   'achou cartao
                ...
                Else
                    ...
                    If VPStrResponse = vbYes Then
                        ...
                        VPStrBox = MsgBox("Cartão criado.", vbInformation, "Guide System - Informação")
...
Sub PegaNumCartao()
    ...
    StrSql = "Select max(NumCartao) as NumCartao From tb_cartao"
    RecCod.Open StrSql, vgCon, 1, 3
    
    If RecCod.EOF Or IsNull(RecCod.Fields.Item(0).Value) Then       'não tem nada cadastrado
        TxtNumCartao.Text = FormataNum(1)
    Else
        TxtNumCartao.Text = FormataNum(RecCod.Fields.Item(0).Value + 1)
    End If
