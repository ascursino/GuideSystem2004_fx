...
Begin VB.Form FrmConsCaixa 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   1080
      OleObjectBlob   =   "FrmConsCaixa.frx":007A
      Top             =   480
   End
   Begin FPSpread.vaSpread GrdCaixa 
      ...
      SpreadDesigner  =   "FrmConsCaixa.frx":02AE
      UserResize      =   1
   End
End
...
Sub MontaGridCx()
    ...
    Do While Not RecResult.EOF
        ...
        If RecResult.Fields.Item(3).Value = "0" Then
            GrdCaixa.Text = ""
        Else
            GrdCaixa.Text = RecResult.Fields.Item(3).Value
        End If
        GrdCaixa.Lock = True
        ...
        If RecResult.Fields.Item(2).Value = "0" Then
            GrdCaixa.Text = ""
        Else
            GrdCaixa.Text = RecResult.Fields.Item(2).Value
        End If
        GrdCaixa.Lock = True
    ...
    GrdCaixa.FontBold = True
    GrdCaixa.Text = Calcula_Moeda(VPIntCred)
    GrdCaixa.Lock = True
    
    GrdCaixa.Col = 5   'Total de Débito
    GrdCaixa.FontBold = True
    GrdCaixa.Text = Calcula_Moeda(VPIntDeb)
    GrdCaixa.Lock = True
    ...
    End If
    GrdCaixa.FontBold = True
    GrdCaixa.Text = Calcula_Moeda(VPIntTotal)
    GrdCaixa.Lock = True
