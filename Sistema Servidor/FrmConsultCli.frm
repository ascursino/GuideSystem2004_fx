...
Sub MontaGridCli()
    ...
    Do While Not RecResult.EOF
        ...
        GrdCli.Col = 18
        GrdCli.Text = RecResult.Fields.Item(19).Value
        GrdCli.Lock = True
           
        GrdCli.Col = 19
        GrdCli.Text = RecResult.Fields.Item(18).Value
        GrdCli.Lock = True
           
        GrdCli.Col = 20
        GrdCli.Text = RecResult.Fields.Item(20).Value
        GrdCli.Lock = True
           
        GrdCli.Col = 21
        GrdCli.Text = RecResult.Fields.Item(21).Value
        GrdCli.Lock = True
...
Private Sub CmdImprimir_Click()
    ...
    font0 = ""
    font1 = "TRIBUS VICTRIX"
    font2 = "Sistema Servidor"
    font3 = "RELATÓRIO DE CLIENTES"
    font4 = "_______________________________________________________________________________________________________________________________________________________"
    
    GrdCli.PrintGrid = False
    GrdCli.PrintBorder = False
    GrdCli.PrintColor = False
        
    GrdCli.PrintHeader = "/l" & font0 & "/c" & font1 & "/n/c" & font2 & "/n/n/n/n/n/c" & font3 & "/n" & font4 & "/n/n/n"
    
    GrdCli.PrintMarginBottom = 400
    GrdCli.PrintMarginLeft = 300
    GrdCli.PrintMarginRight = 300
    GrdCli.PrintMarginTop = 500
    GrdCli.PrintOrientation = PrintOrientationLandscape 'imprime em folha deitada
    GrdCli.PrintShadows = True
    GrdCli.PrintType = PrintTypeAll
    GrdCli.PrintUseDataMax = True
    GrdCli.PrintColHeaders = True
...
Sub MontaCbo()
    ...
    Do While Not RecDt.EOF
        CboDtCad.AddItem (RecDt.Fields.Item(0).Value)
        RecDt.MoveNext
    Loop
...
Private Sub GrdCli_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    If VPStrResponse = vbYes Then
        ...
        StrSql = "Delete from tb_cliente where CodCli=" & GrdCli.Text
        RecCli.Open StrSql, vgCon, 1, 3
        
        StrSql = "Delete from tb_acesso where CodCli=" & GrdCli.Text
        RecAces.Open StrSql, vgCon, 1, 3
        
        StrSql = "Delete from tb_cartao where CodCli=" & GrdCli.Text
        RecCart.Open StrSql, vgCon, 1, 3
        
        If Not RecNumCart.EOF Then
            StrSql = "Delete from tb_credito where NumCartao=" & RecNumCart.Fields.Item(0).Value
