...
Begin VB.Form FrmConsultCred 
   ...
   Begin VB.Frame FraCredito 
      ...
      Begin VB.ComboBox CboNumCart 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "FrmConsultCred.frx":000C
         Left            =   1440
         List            =   "FrmConsultCred.frx":000E
         TabIndex        =   0
      ...
      Begin VB.ComboBox CboDtCred2 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "FrmConsultCred.frx":0010
         Left            =   2880
         List            =   "FrmConsultCred.frx":0012
         TabIndex        =   2
      ...
      Begin VB.ComboBox CboCred 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "FrmConsultCred.frx":0014
         Left            =   1440
         List            =   "FrmConsultCred.frx":0016
         TabIndex        =   3
         ToolTipText     =   "Crédito"
         Top             =   1320
         Width           =   1335
      ...
      Begin VB.ComboBox CboDtCred1 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "FrmConsultCred.frx":0018
         Left            =   1440
         List            =   "FrmConsultCred.frx":001A
         TabIndex        =   1
      ...
      Begin ACTIVESKINLibCtl.SkinLabel LblNumCart 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmConsultCred.frx":001C
         TabIndex        =   8
         Top             =   360
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblDtCred 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmConsultCred.frx":0094
         TabIndex        =   9
         Top             =   840
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblCred 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmConsultCred.frx":0112
         TabIndex        =   10
         Top             =   1320
         Width           =   975
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   1320
      OleObjectBlob   =   "FrmConsultCred.frx":0180
      Top             =   480
   End
