...
Begin VB.Form FrmNiver 
   ...
   Begin VB.Frame FraConsulta 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel LblDia 
         Height          =   255
         Left            =   600
         OleObjectBlob   =   "FrmNiver.frx":0084
         TabIndex        =   9
         Top             =   360
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblMes 
         Height          =   255
         Left            =   1320
         OleObjectBlob   =   "FrmNiver.frx":00E8
         TabIndex        =   10
         Top             =   360
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblDe 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmNiver.frx":014C
         TabIndex        =   11
         Top             =   600
         Width           =   375
      End
      Begin ACTIVESKINLibCtl.SkinLabel LblPara 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmNiver.frx":01B0
         TabIndex        =   5
         Top             =   1080
         Width           =   495
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   480
      OleObjectBlob   =   "FrmNiver.frx":0218
      Top             =   720
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   375
      Left            =   2760
      OleObjectBlob   =   "FrmNiver.frx":044C
      TabIndex        =   8
      Top             =   120
      Width           =   5055
   End
   Begin FPSpread.vaSpread GrdNiver 
      ...
      SpreadDesigner  =   "FrmNiver.frx":04C0
   End
End
...
Private Sub CmdPesquisar_Click()
    ...
    If (CboDeMes.Text <> CboAteMes.Text) And (CboDeMes.Text <> "" And CboAteMes.Text <> "") Then
        LblMesNiver.Caption = CboDeMes.Text & " a " & CboAteMes.Text
    Else
        LblMesNiver.Caption = CboDeMes.Text
    End If
...
Sub MontaGrid()
    ...
    Do While Not RecResult.EOF
        ...
        GrdNiver.Col = 1
        GrdNiver.Text = FormataNum(RecResult.Fields.Item(1).Value) & "/" & FormataNum(RecResult.Fields.Item(2).Value) & "/" & RecResult.Fields.Item(3).Value
        GrdNiver.Lock = True
