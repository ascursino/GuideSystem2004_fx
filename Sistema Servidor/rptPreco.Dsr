VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptPreco 
   Bindings        =   "rptPreco.dsx":0000
   Caption         =   "Relatório de Preços (visualização)"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11895
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Relatório de Preços"
         Alignment       =   1
      EndProperty
      ItemType4       =   3
